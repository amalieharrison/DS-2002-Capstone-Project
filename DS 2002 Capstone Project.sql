...
# DROP database `sakila_dw2`;

CREATE DATABASE `sakila_dw2` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `sakila_dw2`.`dim_rental`
(`rental_id`,
`rental_date`,
`inventory_id`,
`customer_id`,
...
INSERT INTO `sakila_dw2`.`dim_payment`
(`payment_id`,
`customer_id`,
`staff_id`,
`rental_id`,
...
INSERT INTO `sakila_dw2`.`dim_customer`
(`customer_id`,
`store_id`,
`first_name`,
`last_name`,
...
INSERT INTO `sakila_dw2`.`dim_staff`
(`staff_id`,
`first_name`,
`last_name`,
`address_id`,
...
INSERT INTO `sakila_dw2`.`dim_inventory`
(`inventory_id`,
`film_id`,
`store_id`,
`last_update`)
...
INSERT INTO `sakila_dw2`.`dim_actor`
(`actor_id`,
`first_name`,
`last_name`,
`last_update`)
...
INSERT INTO `sakila_dw2`.`dim_category`
(`category_id`,
`name`,
`last_update`)
...
INSERT INTO `sakila_dw2`.`fact_film`
(`title`,
`description`,
`release_year`,
`language_id`,
...
#ALTER TABLE sakila_dw2.dim_rental
...
UPDATE sakila_dw2.dim_rental AS sr
JOIN sakila_dw2.dim_date AS sd
...
ALTER TABLE sakila_dw2.dim_rental
RENAME TO sakila_dw2.fact_rental;
